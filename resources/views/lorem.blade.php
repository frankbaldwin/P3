...
@section('content')
	...
	<p>This simple generator program will create paragraphs of random Latin text. Useful for programmers while testing.</p>
		<br><strong>Step 1:</strong> Select or enter the number of paragraphs you wish to generate.
		</br></br><strong>Step 2:</strong> Click "Submit"</br></br>
		<form name="input" action="lorem" method="post">
			<input type="hidden" name="_token" value="{{ csrf_token() }}">
			Paragraphs (1 - 10): <input type="number" name="paragraphs" min="1" max="10" required/>
